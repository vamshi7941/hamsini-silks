...
export default function Hero() {
  ...
  return (
    <section className={`relative overflow-hidden transition-all duration-500 ${
      isB ? "bg-gradient-to-br from-amber-900 via-amber-800 to-amber-950 text-gold-100" : "bg-gradient-to-br from-maroon-900 via-maroon-800 to-maroon-900 text-gold-100"
    }`}>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 lg:py-20">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full border text-[10px] sm:text-xs tracking-[0.25em] sm:tracking-[0.3em] mb-4 sm:mb-6 ${
              isB ? "bg-gold-500/20 border-gold-300 text-gold-200" : "bg-gold-500/15 border-gold-400/40 text-gold-200"
            }`}>
              <span>✦</span> {isB ? "FESTIVE ATELIER PREVIEW" : "WEDDING COLLECTION 2026"} <span>✦</span>
            </div>
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gold-100/80 max-w-xl mx-auto lg:mx-0 mb-6 sm:mb-8 leading-relaxed px-4 lg:px-0">
              Heirloom Kanjivaram, royal Banarasi and the softest Pattu silks —
              hand-woven by master artisans across generations. Drape a story
              that lasts forever.
            </p>
            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-4 max-w-sm sm:max-w-md mx-auto lg:mx-0 pt-6 sm:pt-8 border-t border-gold-400/20">
              <div>
                <div className="font-display text-xl sm:text-2xl md:text-3xl text-gold-300 font-bold">50+</div>
                <div className="text-[10px] sm:text-xs text-gold-100/70 tracking-wider mt-1">YEARS</div>
              </div>
              <div>
                <div className="font-display text-xl sm:text-2xl md:text-3xl text-gold-300 font-bold">2000+</div>
                <div className="text-[10px] sm:text-xs text-gold-100/70 tracking-wider mt-1">WEAVES</div>
              </div>
              <div>
                <div className="font-display text-xl sm:text-2xl md:text-3xl text-gold-300 font-bold">300+</div>
                <div className="text-[10px] sm:text-xs text-gold-100/70 tracking-wider mt-1">WEAVERS</div>
              </div>
            </div>
          </div>
          ...
          <div className="relative order-1 lg:order-2 flex justify-center">
            <div className="relative w-full max-w-md lg:max-w-none">
              ...
              <div className="relative rounded-[24px] sm:rounded-[36px] overflow-hidden shadow-2xl shadow-black/50 aspect-[4/5]">
                <img
                  src={isB ? "/images/saree-banarasi.jpg" : "/images/hero-bride.jpg"}
                ...
                <div className="absolute bottom-4 left-4 right-4 sm:bottom-6 sm:left-6 sm:right-6 backdrop-blur-md bg-maroon-900/60 border border-gold-400/40 rounded-xl sm:rounded-2xl p-3 sm:p-4 flex items-center justify-between">
                  <div>
                    <div className="text-[8px] sm:text-[10px] tracking-[0.3em] text-gold-300 mb-0.5 sm:mb-1 font-semibold">FEATURED</div>
                  ...
                  <div className="text-right">
                    <div className="text-[8px] sm:text-[10px] text-gold-300/80">FROM</div>
              ...
              <div className="absolute -top-3 -right-3 sm:-top-4 sm:-right-4 lg:-right-6 animate-float">
                <div className={`h-16 w-16 sm:h-24 sm:w-24 rounded-full flex items-center justify-center shadow-2xl ${
                  isB ? "bg-white text-amber-950 border-2 border-gold-400" : "bg-gradient-to-br from-gold-400 to-gold-600 text-maroon-900"
                }`}>
                  <div className="text-center">
                    <div className="font-display text-lg sm:text-2xl leading-none font-bold">30%</div>
                    <div className="text-[8px] sm:text-[9px] tracking-widest sm:mt-1 font-extrabold">OFF</div>
                  </div>
                </div>
              </div>
            </div>
